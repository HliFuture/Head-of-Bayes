...
for fold, (trn_idx, val_idx) in enumerate(skf.split(train_df, train_df['target'])):
    ...
    for i in range(N):
        ...
        evals_result = {}
        lgb_clf = lgb.train(params, trn_data, 100000, valid_sets=[trn_data, val_data], early_stopping_rounds=2500,
...
submission.to_csv("F:/kaggle/submission2.csv", index=False)